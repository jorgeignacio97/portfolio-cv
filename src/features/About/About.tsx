        ...
        <div className={styles.grid}>
          <div className={styles.textBlock}>
            ...
            <p className={styles.para}>
              ...
              <span className={styles.accentAlt}>React y TypeScript</span> en
              módulos clave de SIVi para modernizar el frontend donde el stack
              legacy limita la escalabilidad y mantenibilidad.
            </p>
            <p className={styles.para}>
